...
if [[ $ANTIGEN_CACHE != false ]]; then
  ANTIGEN_CACHE="${ANTIGEN_CACHE:-${ADOTDIR:-$XDG_CONFIG_HOME/antigen}/init.zsh}"
  ANTIGEN_RSRC="${ANTIGEN_RSRC:-${ADOTDIR:-$XDG_CONFIG_HOME/antigen}/.resources}"
...
-antigen-env-setup () {
  ...
  -antigen-set-default ADOTDIR $XDG_CONFIG_HOME/antigen
  ...
  -antigen-set-default ANTIGEN_COMPDUMP "${ADOTDIR:-$XDG_CONFIG_HOME}/.zcompdump"
...
ANTIGEN_DEBUG_LOG=${ANTIGEN_DEBUG_LOG:-${ADOTDIR:-$XDG_CONFIG_HOME/antigen}/debug.log}
LOG () {
